...
def get_heure_debut(creneau):
    ...
    if "matin" in creneau.lower():
        return "08:00" if "1" in creneau or "4h" in creneau else "10:00"
    else:
        return "14:00" if "1" in creneau or "4h" in creneau else "16:00"

def get_heure_fin(creneau):
    """Retourne l'heure de fin en fonction du créneau"""
    if "matin" in creneau.lower():
        return "10:00" if "1" in creneau else "12:00"
    else:
        return "16:00" if "1" in creneau else "18:00"
